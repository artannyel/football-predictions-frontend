...
class HistoryPredictionsTab extends StatelessWidget {
  final String leagueId;
  final String? historyError;
  final List<PredictionModel> historyPredictions;
  final bool isHistoryLoading;
  final VoidCallback onLoadMore;
  final VoidCallback onRefreshDetails;

  const HistoryPredictionsTab({
    super.key,
    required this.leagueId,
    required this.historyError,
    required this.historyPredictions,
  ...
  Widget build(BuildContext context) {
    if (historyError != null && historyPredictions.isEmpty) {
    ...
    if (historyPredictions.isEmpty && isHistoryLoading) {
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: ListView.builder(
        ...
        itemCount: historyPredictions.length + (isHistoryLoading ? 1 : 0),
        itemBuilder: (context, index) {
          if (index == historyPredictions.length) {
          ...
          final prediction = historyPredictions[index];
